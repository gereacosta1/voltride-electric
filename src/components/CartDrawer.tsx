...
export default function CartDrawer() {
  ...
  return (
    ...
    >
      ...
      <aside className="absolute right-0 top-0 h-dvh max-h-dvh w-full max-w-[460px] overflow-hidden">
        <div className="flex h-full min-h-0 flex-col overflow-hidden border-l border-white/10 bg-[#0d1422]/95 shadow-[-24px_0_90px_rgba(0,0,0,.55)] backdrop-blur-2xl md:rounded-l-[30px]">
          ...
          {/* TODO LO QUE ESTÁ DEBAJO DEL HEADER SCROLLEA */}
          <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain">
            ...
            {/* CHECKOUT */}
            <footer
              className="border-t border-white/10 bg-[#0b111d]/95 px-5 pt-5 backdrop-blur-xl"
              style={{
                paddingBottom:
